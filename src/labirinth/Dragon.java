...
public class Dragon extends Entity {
     ...
     */
    public Dragon(int x, int y, int width, int height, Image image, int velX, int velY) {
    ...
    /**
     * A sárkány mozgásának metódusa. A megadott irányba tolja a sárkányt a sebesség mértékével.
